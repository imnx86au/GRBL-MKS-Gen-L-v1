...
void process_spindle_index_pulse()
{
	...
	system_set_threading_exec_flag(EXEC_SYNCHRONIZATION_STATE_REPORT);						// Every index pulse triggers a synchronization status report, not every synchronization pulse!
}
